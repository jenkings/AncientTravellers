...
public class Aporis extends Player 
{
	...
	private final int[] numFrames = {2, 5, 2, 6, 6, 1};
	...
	public Aporis(TileMap tm) 
	{
		...
		try 
		{
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/aporis.png"));
